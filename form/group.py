...
class GroupAdmin:
    ...
    def addGroup(self, title, text, screen, table):
        self.screen = screen
        self.title = title
        self.text = text
        self.table = table
    ...
    def editGroup(self, title, text, screen, table, registro):
        self.screen = screen
        self.title = title
        self.text = text
        self.table = table
        ...
        if rta[0] == "save":
            ...
            for x in range(len(campos)):
                dict_campos[campos[x]] = rta[1][x]
            elf.registro.set(**dict_campos)
            #print dict_campos
        #return rta
        #print dir(self.registro)
        #print self.registro._SO_getValue("ip")

    def deleteGroup(self, screen, table, registro):
        self.screen = screen
        self.table = table
        self.registro = registro
